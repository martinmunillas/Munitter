defmodule Twitter.TimelineTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", like_count: 42, retweet_count: 42, username: "some username"}
    @update_attrs %{body: "some updated body", like_count: 43, retweet_count: 43, username: "some updated username"}
    @invalid_attrs %{body: nil, like_count: nil, retweet_count: nil, username: nil}
